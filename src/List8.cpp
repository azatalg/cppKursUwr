...
private:
    ...
    void Ex_2() {
        const std::regex re(
        R"(^(?:(?:(?:0[1-9]|[12]\d|3[01])-(?:01|03|05|07|08|10|12)|(?:0[1-9]|[12]\d|30)-(?:04|06|09|11)|(?:0[1-9]|1\d|2[0-8])-02)-\d{4}|29-02-(?:(?:\d{2}(?:0[48]|[2468][048]|[13579][26]))|(?:0[48]|[2468][048]|[13579][26])00))$)"
        );

        vec<std::string> ok = {
            "01-01-2000", "31-01-1999", "30-04-2020", "28-02-2023", "29-02-2024"
        };
        vec<std::string> bad = {
